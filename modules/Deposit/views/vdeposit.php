           ...
           <?php echo modules::run("template/sidebar"); ?>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 text-align="center">Kelola Deposit</h4>
                            <a href="<?php echo base_url('tambah_deposit'); ?>""><button type="button" class="btn btn-success">Tambah</button></a>
                            <br>
                            <br />
                                ...
                                <tbody>
                                    <?php foreach ($data as $d) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $d->jml_deposit; ?></td>
                                            <td><?php echo date('d-m-Y', strtotime($d->tgl_create)); ?> </td>
                                            <td><?php echo $d->aktif; ?> </td>
                                            <td style="text-align: center"><a class="btn btn-default" href="<?php echo base_url('edit_deposit/'.$d->id_deposit);?>">Edit</a>  <a onclick="return confirm('Apakah anda yakin ?');" href="<?php echo base_url('delete_deposit/'.$d->id_deposit); ?>" class="btn btn-danger">Hapus</a></td>
