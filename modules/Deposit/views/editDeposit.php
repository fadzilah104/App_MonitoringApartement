                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="header">Kelola Deposit</h4>
                                <form class="form-horizontal" action="<?php echo base_url('update_deposit'); ?>" method="POST">
                                <div class="form-group">
                                        <div class="col-sm-2">
                                            <input type="hidden" class="form-control" id="inputname" placeholder="" name="id_deposit" value="<?php echo $id_deposit; ?>" >
                                        </div>
                                        </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="inputname" placeholder="" name="jml_deposit" value="<?php echo $jml_deposit; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="nokamar" class="col-sm-2 control-label">Status Deposit : </label>
                                        <div class="radio">
                                            <label>
