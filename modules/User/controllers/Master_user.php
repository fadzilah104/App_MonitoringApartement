...
class Master_user extends CI_Controller {
	...
	public function offices()
	{
        ...
        public function index(){
            $data['murl'] = $this->murl;
            // $this->load->view('custom_grocery',$data);
	...
	// }
        ...
        public function QueryBased(){
            try{
                $crud = new grocery_CRUD();
                $crud->set_model('custom_query_model');
                $crud->set_table('employees'); //Change to your table name
                $crud->basic_model->set_custom_query('SELECT * FROM employees'); //Query text here
                $output = $crud->render();
                $this->_example_output($output);
            }catch(Exception $e){
        ...
        public function RemoveComponent(){
            try{
                $crud = new grocery_CRUD();
                $crud->set_model('custom_query_model');
                $crud->set_table('employees_management2s'); //Change to your table name
                $crud->basic_model->set_custom_query('SELECT * FROM employees'); //Query text here
                $crud->unset_add();
                $crud->unset_delete();
                $output = $crud->render();
	...
	public function offices_management()
	{
        ...
        public function CallbackAfterUpdate()
	{
		try{
			$crud = new grocery_CRUD();
        ...
        {
            $city = $this->Moap->getColumn("select city from offices where officeCode = '$primary_key'","city");
            $insert = array(
                'customerName' => $city.'Handoko'
            );
	...
	public function display_as()
	{
			...
			$crud->display_as('officeCode','HandokoGanteng');
	...
	public function customers_management()
	{
			...
			$crud->columns('nama','username','password','akses','status');
			// $crud->display_as('id_penghuni','No')
			// 	 ->display_as('nama','Name')
