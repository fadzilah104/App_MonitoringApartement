...
<body>
	<h1> Monitoring </h1>
	<a href="<?php echo base_url('index.php/Monitoring/data_pelanggan'); ?>"><button>Data Pelanggan</button></a>
		<br>
		<br>
		<div>
			<a href="<?php echo base_url('index.php'); ?>"><button class="btn btn-success">Back</button></a>
		</div>
</body>
</html>