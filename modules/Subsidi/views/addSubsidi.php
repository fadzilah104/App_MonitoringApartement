                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="alert alert-danger">
                                ...
                                <form class="form-horizontal" action="<?php echo base_url('insert_subsidi'); ?>" method="POST">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" id="inputname" placeholder="" name="jml_subsidi">
                                        </div>
                                    </div>
