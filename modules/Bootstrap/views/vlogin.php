...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url($murl.'views/font-awesome/css/font-awesome.min.css') ?>" />

    <script type="text/javascript" src="<?php echo base_url($murl.'views/js/jquery-1.10.2.min.js') ?>"></script>
