                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('')."index.php/tarif/insertTarif"; ?>" method="POST">
                                
                                <div class="form-group">
                                    <label for="deposit" class="col-sm-4 control-label">Tarif : </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="tarif" placeholder="Masukan Tarif" name="tarif">
                                    </div>
                                </div>
                               ...
                               <!--  <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="datetime-local" class="form-control" id="tglmasuk" placeholder="" name="tglmasuk" value="<?php echo date("Y/m/d");?>">
                                    </div>
                                </div> -->
